...
public final class view_005freq_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <h2 class=\"text-center\">Pending Service Requests</h2>\n");
      ...
      out.write("                ");
                    ...
                    try {
                        ...
                        ResultSet rs = stmt.executeQuery("SELECT * FROM service_requests WHERE Status='Pending'");
      ...
      out.write("</td>\n");
      out.write("                                <td>\n");
      out.write("                                    <a href=\"update_requests.jsp?id=");
      out.print( rs.getInt("id") );
      out.write("&status=Accepted\" class=\"btn btn-success\">Accept</a>\n");
      out.write("                                    <a href=\"update_requests.jsp?id=");
      out.print( rs.getInt("id") );
      out.write("&status=Rejected\" class=\"btn btn-danger\">Reject</a>\n");
      out.write("                                </td>\n");
      out.write("                            </tr>\n");
      out.write("                ");
