...
public final class rejected_005frequests_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <h2 class=\"text-center\">Rejected Requests</h2>\n");
      ...
      out.write("                ");
                    ...
                    try {
                        ...
                        ResultSet rs = stmt.executeQuery("SELECT * FROM service_requests WHERE Status='Rejected'");
                        while (rs.next()) {
