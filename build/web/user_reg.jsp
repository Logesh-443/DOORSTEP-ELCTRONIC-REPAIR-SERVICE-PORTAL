<%-- 
    Document   : user_reg
    Created on : 13 Mar, 2025, 12:57:11 PM
...
<html>
    ...
    <nav class="navbar navbar-inverse">
        ...
        <div class="container">
            <h3 style="text-align:center;color:red;">USER</h3>
            <div class="row">
                <div class="col-md-3"></div>
                <div class="col-md-8"></div>
                <form method="post" action="./user_servlet"enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="Submit"name="add"class="btn-btn-success"value="register"/>
                    </div>
                    </div>   
                </form>
        </div>
