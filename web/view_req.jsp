<%-- 
    Document   : view_req
    Created on : 13 Mar, 2025, 10:15:02 PM
...
<!--     <div class="d-flex">
    ...
    <div class="container">
        <h2 class="text-center">Pending Service Requests</h2>
            ...
            <tbody>
                ...
                %>
                            <tr>
                                ...
                                <td>
                                    <a href="update_requests.jsp?id=<%= rs.getInt("id") %>&status=Accepted" class="btn btn-success">Accept</a>
                                    <a href="update_requests.jsp?id=<%= rs.getInt("id") %>&status=Rejected" class="btn btn-danger">Reject</a>
                                </td>
                            </tr>
                <%
                        }
